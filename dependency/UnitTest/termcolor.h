...
namespace termcolor
{
	...
	inline
		std::ostream& lightRed(std::ostream& stream)
	{
		if (__internal::is_atty(stream))
		{
		#if defined(OS_MACOS) || defined(OS_LINUX)
	...
	inline
		std::ostream& lightGreen(std::ostream& stream)
	{
		if (__internal::is_atty(stream))
		{
		#if defined(OS_MACOS) || defined(OS_LINUX)
	...
	inline
		std::ostream& lightYellow(std::ostream& stream)
	{
		if (__internal::is_atty(stream))
		{
		#if defined(OS_MACOS) || defined(OS_LINUX)
	...
	inline
		std::ostream& lightBlue(std::ostream& stream)
	{
		if (__internal::is_atty(stream))
		{
		#if defined(OS_MACOS) || defined(OS_LINUX)
	...
	inline
		std::ostream& lightMagenta(std::ostream& stream)
	{
		if (__internal::is_atty(stream))
		{
		#if defined(OS_MACOS) || defined(OS_LINUX)
	...
	inline
		std::ostream& lightCyan(std::ostream& stream)
	{
		if (__internal::is_atty(stream))
		{
		#if defined(OS_MACOS) || defined(OS_LINUX)
	...
	inline
		std::ostream& lightWhite(std::ostream& stream)
	{
		if (__internal::is_atty(stream))
		{
		#if defined(OS_MACOS) || defined(OS_LINUX)
